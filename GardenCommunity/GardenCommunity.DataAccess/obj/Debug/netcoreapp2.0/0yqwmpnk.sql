...
VALUES (N'20180527103359_DataBase_Created_EF_CORE', N'2.0.3-rtm-10026');
...
WHERE ([d].[parent_object_id] = OBJECT_ID(N'MembersAreas') AND [c].[name] = N'OwnedTo');
IF @var0 IS NOT NULL EXEC(N'ALTER TABLE [MembersAreas] DROP CONSTRAINT [' + @var0 + '];');
ALTER TABLE [MembersAreas] ALTER COLUMN [OwnedTo] datetime2 NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180527120711_Field ownetTo is nullable', N'2.0.3-rtm-10026');
